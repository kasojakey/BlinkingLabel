...
// BlinkingLabel
#define COCOAPODS_POD_AVAILABLE_BlinkingLabel
#define COCOAPODS_VERSION_MAJOR_BlinkingLabel 0
#define COCOAPODS_VERSION_MINOR_BlinkingLabel 1
#define COCOAPODS_VERSION_PATCH_BlinkingLabel 0
